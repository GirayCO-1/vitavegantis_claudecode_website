...
export const metadata: Metadata = {
  title: "Where to Buy",
  description:
    "The online stores and marketplaces where you can find VitaVegantis products.",
  alternates: {
    canonical: canonical("en/sales-points"),
    languages: {
      "tr-TR": canonical("satisnoktalari"),
      en: canonical("en/sales-points"),
    },
  },
  openGraph: {
    type: "website",
    locale: "en_US",
    url: canonical("en/sales-points"),
    title: "Where to Buy — VitaVegantis",
    description:
      "The online stores and marketplaces where you can find VitaVegantis products.",
...
export default function SalesPointsPageEn() {
  return (
    <>
      <JsonLd
        data={breadcrumbSchema([
          { name: "Home", path: "en" },
          { name: "Where to Buy", path: "en/sales-points" },
        ])}
      />
      <section className="px-6 py-20">
        <div className="mx-auto max-w-5xl">
          <div className="mx-auto max-w-2xl text-center">
            <p className="font-accent text-2xl text-plum">Find us</p>
            <h1 className="font-display mt-2 text-4xl font-semibold text-forest sm:text-5xl">
              Where to Buy
            </h1>
            <p className="mt-4 text-forest/70">
              You can find VitaVegantis products at these online stores and
              marketplaces.
            </p>
          </div>
